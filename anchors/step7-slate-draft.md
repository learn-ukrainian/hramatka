...
| 10 | A2 | ABOVE-B1 literary prose — **slot open** | pick via `search_literary` at pre-reg (direction: класична проза — Коцюбинський/Яновський). Alternate: Антоненко «Застінок, катівня» (~L1003, probe ✓, ~600) | ~1500 | «grade the task, not the text» — gates must not reject the text for difficulty; tasks stay B1 |
