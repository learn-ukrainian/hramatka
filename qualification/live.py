...
def preflight_live_qualification(
    ...
    *,
    ...
    matrix = _matrix()
    if len(matrix) != 6 or len({route.route_id for _, route in matrix}) != 6:
        raise LiveQualificationError("Qualification matrix is not exactly six unique routes.")
...
def execute_live_qualification(
    ...
    *,
    ...
    """Run the preflighted 18-cell matrix through the ordinary production API path."""
