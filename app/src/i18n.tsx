...
const DICT = {
  ...
  'studentActivity.chooseBlank': { uk: '_____', en: '_____' },
  'studentActivity.fillBlank': { uk: 'Оберіть відповідь для пропуску {n}: _____', en: 'Choose an answer for blank {n}: _____' },
  'studentActivity.clozeBlank': { uk: 'Оберіть відповідь для пропуску {n}: _____', en: 'Choose an answer for blank {n}: _____' },
